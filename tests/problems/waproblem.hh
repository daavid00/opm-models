 ...
 * \file
 *
 * \copydoc Opm::Co2WaProblem
 */
#ifndef EWOMS_CO2_WA_PROBLEM_HH
#define EWOMS_CO2_WA_PROBLEM_HH
...
// Set the grid type
template<class TypeTag>
struct Grid<TypeTag, TTag::Co2WaBaseProblem> { using type = Dune::YaspGrid<3>; };

// Set the problem property
template<class TypeTag>
struct Problem<TypeTag, TTag::Co2WaBaseProblem>
{ using type = Opm::Co2WaProblem<TypeTag>; };

// Set fluid configuration
template<class TypeTag>
struct FluidSystem<TypeTag, TTag::Co2WaBaseProblem>
{
private:
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using CO2Tables = Opm::Co2Wa::CO2Tables;
...
template<class TypeTag>
struct MaterialLaw<TypeTag, TTag::Co2WaBaseProblem>
{
private:
...
template<class TypeTag>
struct ThermalConductionLaw<TypeTag, TTag::Co2WaBaseProblem>
{
private:
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using FluidSystem = GetPropType<TypeTag, Properties::FluidSystem>;
...
template<class TypeTag>
struct SolidEnergyLaw<TypeTag, TTag::Co2WaBaseProblem>
...
template<class TypeTag>
struct LinearSolverSplice<TypeTag, TTag::Co2WaBaseProblem> { using type = TTag::ParallelAmgLinearSolver; };

// Write the Newton convergence behavior to disk?
template<class TypeTag>
struct NewtonWriteConvergence<TypeTag, TTag::Co2WaBaseProblem> { static constexpr bool value = false; };

// Enable molecular diffusion for this problem
template<class TypeTag>
struct EnableDiffusion<TypeTag, TTag::Co2WaBaseProblem> { static constexpr bool value = true; };

// Enable gravity
template<class TypeTag>
struct EnableGravity<TypeTag, TTag::Co2WaBaseProblem> { static constexpr bool value = true; };

// set the defaults for the problem specific properties
template<class TypeTag>
struct FluidSystemPressureLow<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 3e7;
};
template<class TypeTag>
struct FluidSystemPressureHigh<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 4e7;
};
template<class TypeTag>
struct FluidSystemNumPressure<TypeTag, TTag::Co2WaBaseProblem> { static constexpr int value = 100; };
template<class TypeTag>
struct FluidSystemTemperatureLow<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 290;
};
template<class TypeTag>
struct FluidSystemTemperatureHigh<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 500;
};
template<class TypeTag>
struct FluidSystemNumTemperature<TypeTag, TTag::Co2WaBaseProblem> { static constexpr int value = 100; };

template<class TypeTag>
struct MaxDepth<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 2500;
};
template<class TypeTag>
struct KC<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 1E-16;
};
template<class TypeTag>
struct K<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 1E-10;
};
template<class TypeTag>
struct PhiC<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 0.2;
};
template<class TypeTag>
struct Phi<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 0.2;
};
template<class TypeTag>
struct CiC<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 1e4;
};
template<class TypeTag>
struct CfC<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 1e2;
};
template<class TypeTag>
struct S0w<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 0.5;
};
template<class TypeTag>
struct X0n<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 5e-3;
};
template<class TypeTag>
struct FineLayerBottom<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 70.;
};
template<class TypeTag>
struct Temperature<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
    static constexpr type value = 293.15;
};
template<class TypeTag>
struct SimulationName<TypeTag, TTag::Co2WaBaseProblem> { static constexpr auto value = "wa"; };

// The default for the end time of the simulation
template<class TypeTag>
struct EndTime<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
...
template<class TypeTag>
struct InitialTimeStepSize<TypeTag, TTag::Co2WaBaseProblem>
{
    using type = GetPropType<TypeTag, Scalar>;
...
template<class TypeTag>
struct GridFile<TypeTag, TTag::Co2WaBaseProblem> { static constexpr auto value = "wa.dgf"; };
 ...
 *
 * \brief Problem where \f$CO_2\f$ is stored under a low permeable
 *        layer at a depth of 2700m.
 *
 * The domain is sized 10m times 1m times 100m and consists of two layers, one
 ...
 *
 * Initially \f$CO_2\f$ is uniformly distributed in the permeble zone at 0.5
 * saturation and the \f$CO_2\f$ mole fraction in brine phase is set to 0.005.
 * f$CO_2\f$ migrates upwards due to buoyancy and diffusion. It accumulates and
 * eventually enters the lower permeable zone (wettability alteration).
 *
 * The boundary conditions applied by this problem are no-flow
 * conditions.
 */
template <class TypeTag>
class Co2WaProblem : public GetPropType<TypeTag, Properties::BaseProblem>
{
...
public:
     ...
     */
    Co2WaProblem(Simulator& simulator)
    ...
    void finishInit()
    {
        ...
        coarseMaterialParams_.setResidualSaturation(gasPhaseIdx, srn_);
